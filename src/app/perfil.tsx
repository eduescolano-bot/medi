...
const styles = StyleSheet.create({
  ...
  topBarTitulo: { flex: 1 },
  topBarTexto: { fontFamily: 'Poppins-Bold', fontSize: 15, color: '#0B3A5C' },
  botonInicio: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 7,
  ...
  avatarTexto: { color: '#ffffff', fontFamily: 'Poppins-SemiBold', fontSize: 22 },
  avatarFoto: { width: 68, height: 68, borderRadius: 34, marginBottom: 12, backgroundColor: '#E4EBF0' },
  nombre: { fontFamily: 'Poppins-Bold', fontSize: 19, color: '#0B3A5C', textAlign: 'center' },
  matricula: { fontFamily: 'WorkSans-Regular', fontSize: 12.5, color: '#64748B', marginTop: 2 },
  ...
  chipEspecialidadTexto: { fontFamily: 'WorkSans-SemiBold', fontSize: 12.5, color: '#0B3A5C' },
  chipObraSocial: {
  ...
  chipObraSocialTexto: { fontFamily: 'WorkSans-SemiBold', fontSize: 12.5, color: '#52514E' },
  badgeDomicilio: {
  ...
  badgeDomicilioTexto: { fontFamily: 'WorkSans-SemiBold', fontSize: 12.5, color: '#0B8275' },
  ...
  bio: { fontFamily: 'WorkSans-Regular', fontSize: 14, color: '#0B3A5C', lineHeight: 20 },
  consultorioCard: {
    backgroundColor: '#ffffff',
    borderWidth: 1,
    borderColor: '#E4EBF0',
  ...
  consultorioNombre: { fontFamily: 'Poppins-SemiBold', fontSize: 14.5, color: '#0B3A5C', marginBottom: 3 },
  consultorioDetalle: { fontFamily: 'WorkSans-Regular', fontSize: 13, color: '#52514E', marginTop: 2 },
  horariosBox: { marginTop: 8, gap: 2 },
  horarioLinea: { fontFamily: 'WorkSans-Regular', fontSize: 12.5, color: '#64748B' },
  botonComoLlegar: {
  ...
  botonComoLlegarTexto: { fontFamily: 'WorkSans-SemiBold', fontSize: 12.5, color: '#0B3A5C' },
  botonContacto: {
  ...
  botonContactoTexto: { color: '#ffffff', fontFamily: 'Poppins-SemiBold', fontSize: 14.5 },
});
